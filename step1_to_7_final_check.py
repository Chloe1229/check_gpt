...
STEP7_ROWS_LIST = [{'condition': '(step6_selections.get("s1_1_req_1") == "충족")',
  ...
  'step': '7',
  'subitem_and_requirements_state': '(subitem_met == "") and (requirements_met != "") and (requirements_unmet == "")',
  'subitem_met': 'step6_selections.get("s1_1_req_1") == "충족"',
  'title_key': 's1_1',
  'title_text': '3.2.S.1 일반정보\n1. 원료의약품 명칭변경'},
 {'condition': '(step6_selections.get("s2_2_sub_2a") == "변경 있음") and (step6_selections.get("s2_2_req_3") == "충족" and '
               'step6_selections.get("s2_2_req_4") == "충족" and step6_selections.get("s2_2_req_9") == "충족") and '
               '(step6_selections.get("s2_2_req_1") == "미충족" and step6_selections.get("s2_2_req_2") == "미충족" and '
               'step6_selections.get("s2_2_req_5") == "미충족" and step6_selections.get("s2_2_req_6") == "미충족" and '
               'step6_selections.get("s2_2_req_7") == "미충족" and step6_selections.get("s2_2_req_8") == "미충족" and '
  ...
  'output_2_text': '필요서류는 다음과 같습니다.\n'
                   '\n'
                   '1. (해당되는 경우) 해당 품목을 제조하는 제조소에 ‘의약품 등의 안전에 관한 규칙’ 제48조의2에 따른 제조 및 품질관리기준 적합판정서, 해외 제조원인 경우 '
                   '제4조제1항제4호에 따른 유효기간 내의 제조증명서.\n'
 ...
 {'condition': '(step6_selections.get("s2_2_sub_2a") == "변경 있음") and (step6_selections.get("s2_2_req_1") == "미충족" and '
               'step6_selections.get("s2_2_req_2") == "미충족" and step6_selections.get("s2_2_req_3") == "미충족" and '
               'step6_selections.get("s2_2_req_4") == "미충족" and step6_selections.get("s2_2_req_5") == "미충족" and '
               'step6_selections.get("s2_2_req_6") == "미충족" and step6_selections.get("s2_2_req_7") == "미충족" and '
               'step6_selections.get("s2_2_req_8") == "미충족" and step6_selections.get("s2_2_req_9") == "미충족" and '
               'step6_selections.get("s2_2_req_10") == "미충족")',
  'heading_text': '3.2.S 원료의약품',
  'output_1_tag': '보고유형은 다음과 같습니다.\n'
                  '\n'
                  'Cmaj, 변경허가(신고)\n'
                  '「의약품의 품목허가‧신고‧심사 규정」 제3조의2(의약품의 허가‧신고의 변경 처리) 및 제6조(국제공통기술문서 작성)에 따라 원료의약품과 완제의약품의 제조원 또는 제조방법 중 '
                  '품질에 중요한 영향을 미치는 변경허가(신고) 신청(Change, C) 대상에 해당하며, 변경사항의 중요도, 충족조건 및 제출자료 요건의 난이도 등을 고려하였을 때 Major '
                  'change(Cmaj)수준의 변경사항입니다.',
  ...
  'title_key': 's2_2',
  'title_text': '3.2.S.2 제조\n2. 원료의약품의 제조소 또는 제조업자의 변경 또는 추가'},
 {'condition': '(step6_selections.get("s2_2_sub_2b") == "변경 있음") and (step6_selections.get("s2_2_req_3") == "충족" and '
               'step6_selections.get("s2_2_req_5") == "충족") and (step6_selections.get("s2_2_req_1") == "미충족" and '
               'step6_selections.get("s2_2_req_2") == "미충족" and step6_selections.get("s2_2_req_4") == "미충족" and '
               'step6_selections.get("s2_2_req_6") == "미충족" and step6_selections.get("s2_2_req_7") == "미충족" and '
               'step6_selections.get("s2_2_req_8") == "미충족" and step6_selections.get("s2_2_req_9") == "미충족" and '
               'step6_selections.get("s2_2_req_10") == "미충족")',
  'heading_text': '3.2.S 원료의약품',
  ...
  'title_key': 's2_2',
  'title_text': '3.2.S.2 제조\n2. 원료의약품의 제조소 또는 제조업자의 변경 또는 추가'},
 {'condition': '(step6_selections.get("s2_2_sub_2b") == "변경 있음") and (step6_selections.get("s2_2_req_1") == "미충족" and '
               'step6_selections.get("s2_2_req_2") == "미충족" and step6_selections.get("s2_2_req_3") == "미충족" and '
               'step6_selections.get("s2_2_req_4") == "미충족" and step6_selections.get("s2_2_req_5") == "미충족" and '
               'step6_selections.get("s2_2_req_6") == "미충족" and step6_selections.get("s2_2_req_7") == "미충족" and '
               'step6_selections.get("s2_2_req_8") == "미충족" and step6_selections.get("s2_2_req_9") == "미충족" and '
  ...
  'title_key': 's2_2',
  'title_text': '3.2.S.2 제조\n2. 원료의약품의 제조소 또는 제조업자의 변경 또는 추가'},
 {'condition': '(step6_selections.get("s2_2_sub_2c") == "변경 있음") and (step6_selections.get("s2_2_req_1") == "충족" and '
               'step6_selections.get("s2_2_req_2") == "충족" and step6_selections.get("s2_2_req_3") == "충족" and '
               'step6_selections.get("s2_2_req_6") == "충족" and step6_selections.get("s2_2_req_7") == "충족" and '
               'step6_selections.get("s2_2_req_8") == "충족") and (step6_selections.get("s2_2_req_4") == "미충족" and '
               'step6_selections.get("s2_2_req_5") == "미충족" and step6_selections.get("s2_2_req_9") == "미충족" and '
               'step6_selections.get("s2_2_req_10") == "미충족")',
  'heading_text': '3.2.S 원료의약품',
  'output_1_tag': 'IR',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
  ...
  'title_key': 's2_2',
  'title_text': '3.2.S.2 제조\n2. 원료의약품의 제조소 또는 제조업자의 변경 또는 추가'},
 {'condition': '(step6_selections.get("s2_2_sub_2c") == "변경 있음") and (step6_selections.get("s2_2_req_1") == "미충족" and '
               'step6_selections.get("s2_2_req_2") == "미충족" and step6_selections.get("s2_2_req_3") == "미충족" and '
               'step6_selections.get("s2_2_req_4") == "미충족" and step6_selections.get("s2_2_req_5") == "미충족" and '
               'step6_selections.get("s2_2_req_6") == "미충족" and step6_selections.get("s2_2_req_7") == "미충족" and '
               'step6_selections.get("s2_2_req_8") == "미충족" and step6_selections.get("s2_2_req_9") == "미충족" and '
  ...
  'title_key': 's2_2',
  'title_text': '3.2.S.2 제조\n2. 원료의약품의 제조소 또는 제조업자의 변경 또는 추가'},
 {'condition': '(step6_selections.get("s2_2_sub_2c") == "변경 있음") and (step6_selections.get("s2_2_req_10") == "충족") and '
               '(step6_selections.get("s2_2_req_1") == "미충족" and step6_selections.get("s2_2_req_2") == "미충족" and '
               'step6_selections.get("s2_2_req_3") == "미충족" and step6_selections.get("s2_2_req_4") == "미충족" and '
               'step6_selections.get("s2_2_req_5") == "미충족" and step6_selections.get("s2_2_req_6") == "미충족" and '
               'step6_selections.get("s2_2_req_7") == "미충족" and step6_selections.get("s2_2_req_8") == "미충족" and '
               'step6_selections.get("s2_2_req_9") == "미충족")',
  'heading_text': '3.2.S 원료의약품',
  ...
  'output_1_text': '보고유형은 다음과 같습니다.\n'
                   ...
                   'Cmin, 변경허가(신고)\n'
                   '「의약품의 품목허가‧신고‧심사 규정」 제3조의2(의약품의 허가‧신고의 변경 처리) 및 제6조(국제공통기술문서 작성)에 따라 원료의약품과 완제의약품의 제조원 또는 제조방법 중 '
                   '품질에 중요한 영향을 미치는 변경허가(신고) 신청(Change, C) 대상에 해당하며, 변경사항의 중요도, 충족조건 및 제출자료 요건의 난이도 등을 고려하였을 때 Minor '
                   'change(Cmin)수준의 변경사항입니다.',
  'output_2_text': '필요서류는 다음과 같습니다.\n'
                   '\n'
  ...
  'title_key': 's2_2',
  'title_text': '3.2.S.2 제조\n2. 원료의약품의 제조소 또는 제조업자의 변경 또는 추가'},
 {'condition': '(step6_selections.get("s2_3_req_1") == "충족" and step6_selections.get("s2_3_req_2") == "충족" and '
               'step6_selections.get("s2_3_req_3") == "충족" and step6_selections.get("s2_3_req_4") == "충족" and '
               'step6_selections.get("s2_3_req_5") == "충족" and step6_selections.get("s2_3_req_6") == "충족" and '
               'step6_selections.get("s2_3_req_7") == "충족" and step6_selections.get("s2_3_req_8") == "충족") and '
  ...
  'title_text': '3.2.S.2 제조\n3. 원료의약품 제조 공정의 변경'},
 {'condition': '(step6_selections.get("s2_3_req_1") == "충족" and step6_selections.get("s2_3_req_2") == "충족" and '
               'step6_selections.get("s2_3_req_3") == "충족" and step6_selections.get("s2_3_req_5") == "충족" and '
               'step6_selections.get("s2_3_req_6") == "충족" and step6_selections.get("s2_3_req_7") == "충족" and '
               'step6_selections.get("s2_3_req_9") == "충족") and (step6_selections.get("s2_3_req_4") == "미충족" and '
 ...
 {'condition': '(step6_selections.get("s2_3_req_1") == "충족" and step6_selections.get("s2_3_req_2") == "충족" and '
               'step6_selections.get("s2_3_req_3") == "충족" and step6_selections.get("s2_3_req_4") == "충족" and '
               'step6_selections.get("s2_3_req_5") == "충족" and step6_selections.get("s2_3_req_6") == "충족") and '
               '(step6_selections.get("s2_3_req_7") == "미충족" and step6_selections.get("s2_3_req_8") == "미충족" and '
               'step6_selections.get("s2_3_req_9") == "미충족")',
  'heading_text': '3.2.S 원료의약품',
  'output_1_tag': '보고유형은 다음과 같습니다.\n'
                  '\n'
  ...
  'title_key': 's2_3',
  'title_text': '3.2.S.2 제조\n3. 원료의약품 제조 공정의 변경'},
 {'condition': '(step6_selections.get("s2_3_req_1") == "미충족" and step6_selections.get("s2_3_req_2") == "미충족" and '
               'step6_selections.get("s2_3_req_3") == "미충족" and step6_selections.get("s2_3_req_4") == "미충족" and '
               'step6_selections.get("s2_3_req_5") == "미충족" and step6_selections.get("s2_3_req_6") == "미충족" and '
               'step6_selections.get("s2_3_req_7") == "미충족" and step6_selections.get("s2_3_req_8") == "미충족" and '
               'step6_selections.get("s2_3_req_9") == "미충족")',
  'heading_text': '3.2.S 원료의약품',
  'output_1_tag': '필요서류는 다음과 같습니다.\n'
  ...
  'requirements_unmet': '보고유형은 다음과 같습니다.\n'
                        '\n'
                        'Cmaj, 변경허가(신고)\n'
                        '「의약품의 품목허가‧신고‧심사 규정」 제3조의2(의약품의 허가‧신고의 변경 처리) 및 제6조(국제공통기술문서 작성)에 따라 원료의약품과 완제의약품의 제조원 또는 '
                        '제조방법 중 품질에 중요한 영향을 미치는 변경허가(신고) 신청(Change, C) 대상에 해당하며, 변경사항의 중요도, 충족조건 및 제출자료 요건의 난이도 등을 '
                        '고려하였을 때 Major change(Cmaj)수준의 변경사항입니다.',
  'step': '7',
  'subitem_and_requirements_state': '(subitem_met == "") and (requirements_met == "") and (requirements_unmet != "")',
  ...
  'title_key': 's2_3',
  'title_text': '3.2.S.2 제조\n3. 원료의약품 제조 공정의 변경'},
 {'condition': '(step6_selections.get("s2_4_sub_4a") == "변경 있음") and (step6_selections.get("s2_4_req_1") == "충족" and '
               'step6_selections.get("s2_4_req_2") == "충족" and step6_selections.get("s2_4_req_3") == "충족") and '
               '(step6_selections.get("s2_4_req_4") == "미충족" and step6_selections.get("s2_4_req_5") == "미충족")',
  'heading_text': '3.2.S 원료의약품',
  'output_1_tag': 'AR',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
                   ' \n'
  ...
  'title_key': 's2_4',
  'title_text': '3.2.S.2 제조\n4. 원료의약품 제조 공정관리 규격의 변경'},
 {'condition': '(step6_selections.get("s2_4_sub_4b") == "변경 있음") and (step6_selections.get("s2_4_req_1") == "충족") and '
               '(step6_selections.get("s2_4_req_2") == "미충족" and step6_selections.get("s2_4_req_3") == "미충족" and '
               'step6_selections.get("s2_4_req_4") == "미충족" and step6_selections.get("s2_4_req_5") == "미충족")',
  'heading_text': '3.2.S 원료의약품',
  'output_1_tag': 'AR',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
  ...
  'title_key': 's2_4',
  'title_text': '3.2.S.2 제조\n4. 원료의약품 제조 공정관리 규격의 변경'},
 {'condition': '(step6_selections.get("s2_4_sub_4c") == "변경 있음") and (step6_selections.get("s2_4_req_1") == "미충족" and '
               'step6_selections.get("s2_4_req_2") == "미충족" and step6_selections.get("s2_4_req_3") == "미충족" and '
               'step6_selections.get("s2_4_req_4") == "미충족" and step6_selections.get("s2_4_req_5") == "미충족" and '
               'step6_selections.get("s2_4_req_7") == "미충족" and step6_selections.get("s2_4_req_8") == "미충족" and '
               'step6_selections.get("s2_4_req_9") == "미충족" and step6_selections.get("s2_4_req_10") == "미충족")',
  'heading_text': '3.2.S 원료의약품',
  'output_1_tag': '보고유형은 다음과 같습니다.\n'
                  '\n'
                  'Cmin, 변경허가(신고)\n'
  ...
  'output_1_text': '필요서류는 다음과 같습니다.\n'
                   ...
                   '3. (S.2.4) 변경 후 공정관리 시험 규격에 관한 자료.\n'
                   '5. 공정관리 시험(추가, 교체, 삭제, 완화되는) 규격에 대한 타당성 입증 자료 또는 설명자료.\n'
                   '7. (S.2.5) 무균원료의약품인 경우, 해당 공정기준 변경이 제품의 무균 및 멸균공정에 영향을 미칠 경우(위험도 평가 결과에 따른), 해당 공정에 대한 밸리데이션 자료 또는 '
                   '평가 자료.\n'
  ...
  'title_key': 's2_4',
  'title_text': '3.2.S.2 제조\n4. 원료의약품 제조 공정관리 규격의 변경'},
 {'condition': '(step6_selections.get("s2_4_sub_4d") == "변경 있음") and (step6_selections.get("s2_4_req_1") == "충족" and '
               'step6_selections.get("s2_4_req_4") == "충족" and step6_selections.get("s2_4_req_5") == "충족") and '
               '(step6_selections.get("s2_4_req_2") == "미충족" and step6_selections.get("s2_4_req_3") == "미충족")',
  'heading_text': '3.2.S 원료의약품',
  'output_1_tag': 'AR',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
                   ' \n'
 ...
 {'condition': '(step6_selections.get("s2_4_sub_4d") == "변경 있음") and (step6_selections.get("s2_4_req_1") == "충족") and '
  ...
  'title_key': 's2_4',
  'title_text': '3.2.S.2 제조\n4. 원료의약품 제조 공정관리 규격의 변경'},
 {'condition': '(step6_selections.get("s2_4_sub_4e") == "변경 있음") and (step6_selections.get("s2_4_req_1") == "충족") and '
               '(step6_selections.get("s2_4_req_2") == "미충족" and step6_selections.get("s2_4_req_3") == "미충족" and '
               'step6_selections.get("s2_4_req_4") == "미충족" and step6_selections.get("s2_4_req_5") == "미충족")',
  'heading_text': '3.2.S 원료의약품',
  'output_1_tag': 'Cmaj',
  ...
  'title_key': 's2_4',
  'title_text': '3.2.S.2 제조\n4. 원료의약품 제조 공정관리 규격의 변경'},
 {'condition': '(step6_selections.get("s2_5_sub_5a") == "변경 있음") and (step6_selections.get("s2_5_req_1") == "충족" and '
               'step6_selections.get("s2_5_req_2") == "충족" and step6_selections.get("s2_5_req_3") == "충족")',
  'heading_text': '3.2.S 원료의약품',
  'output_1_tag': '보고유형은 다음과 같습니다.\n'
                  ' \n'
                  'AR, 연차보고\n'
  ...
  'title_key': 's2_5',
  'title_text': '3.2.S.2 제조\n5. 원료의약품 또는 중간체의 제조 규모 변경'},
 {'condition': '(step6_selections.get("s2_5_sub_5b") == "변경 있음") and (step6_selections.get("s2_5_req_1") == "충족" and '
               'step6_selections.get("s2_5_req_2") == "충족" and step6_selections.get("s2_5_req_3") == "충족")',
  'heading_text': '3.2.S 원료의약품',
  'output_1_tag': '보고유형은 다음과 같습니다.\n'
                  ' \n'
  ...
  'title_key': 's2_5',
  'title_text': '3.2.S.2 제조\n5. 원료의약품 또는 중간체의 제조 규모 변경'},
 {'condition': '(step6_selections.get("s2_5_sub_5c") == "변경 있음") and (step6_selections.get("s2_5_req_1") == "충족" and '
               'step6_selections.get("s2_5_req_2") == "충족" and step6_selections.get("s2_5_req_3") == "충족")',
  'heading_text': '3.2.S 원료의약품',
  'output_1_tag': '보고유형은 다음과 같습니다.\n'
                  '\n'
  ...
  'title_key': 's2_5',
  'title_text': '3.2.S.2 제조\n5. 원료의약품 또는 중간체의 제조 규모 변경'},
 {'condition': '(step6_selections.get("s2_6_sub_6a") == "변경 있음") and (step6_selections.get("s2_6_req_1") == "충족" and '
               'step6_selections.get("s2_6_req_2") == "충족" and step6_selections.get("s2_6_req_3") == "충족") and '
               '(step6_selections.get("s2_6_req_4") == "미충족" and step6_selections.get("s2_6_req_5") == "미충족" and '
               'step6_selections.get("s2_6_req_6") == "미충족" and step6_selections.get("s2_6_req_7") == "미충족" and '
               'step6_selections.get("s2_6_req_8") == "미충족" and step6_selections.get("s2_6_req_9") == "미충족")',
  'heading_text': '3.2.S 원료의약품',
  'output_1_tag': 'AR',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
                   ' \n'
 ...
 {'condition': '(step6_selections.get("s2_6_sub_6b") == "변경 있음") and (step6_selections.get("s2_6_req_4") == "충족" and '
               'step6_selections.get("s2_6_req_5") == "충족" and step6_selections.get("s2_6_req_6") == "충족") and '
               '(step6_selections.get("s2_6_req_1") == "미충족" and step6_selections.get("s2_6_req_2") == "미충족" and '
               'step6_selections.get("s2_6_req_3") == "미충족" and step6_selections.get("s2_6_req_7") == "미충족" and '
               'step6_selections.get("s2_6_req_8") == "미충족" and step6_selections.get("s2_6_req_9") == "미충족")',
  'heading_text': '3.2.S 원료의약품',
  'output_1_tag': 'AR',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
  ...
  'title_key': 's2_6',
  'title_text': '3.2.S.2 제조\n6. 원료의약품의 제조에 사용되는 원료(출발물질, 중간체, 용매, 시약 등)의 규격변경'},
 {'condition': '(step6_selections.get("s2_6_sub_6c") == "변경 있음") and (step6_selections.get("s2_6_req_1") == "충족" and '
               'step6_selections.get("s2_6_req_5") == "충족" and step6_selections.get("s2_6_req_6") == "충족" and '
               'step6_selections.get("s2_6_req_7") == "충족") and (step6_selections.get("s2_6_req_2") == "미충족" and '
               'step6_selections.get("s2_6_req_3") == "미충족" and step6_selections.get("s2_6_req_4") == "미충족" and '
               'step6_selections.get("s2_6_req_8") == "미충족" and step6_selections.get("s2_6_req_9") == "미충족")',
  'heading_text': '3.2.S 원료의약품',
  'output_1_tag': 'AR',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
  ...
  'title_key': 's2_6',
  'title_text': '3.2.S.2 제조\n6. 원료의약품의 제조에 사용되는 원료(출발물질, 중간체, 용매, 시약 등)의 규격변경'},
 {'condition': '(step6_selections.get("s2_6_sub_6d") == "변경 있음") and (step6_selections.get("s2_6_req_1") == "충족" and '
               'step6_selections.get("s2_6_req_8") == "충족" and step6_selections.get("s2_6_req_9") == "충족") and '
               '(step6_selections.get("s2_6_req_2") == "미충족" and step6_selections.get("s2_6_req_3") == "미충족" and '
               'step6_selections.get("s2_6_req_4") == "미충족" and step6_selections.get("s2_6_req_5") == "미충족" and '
               'step6_selections.get("s2_6_req_6") == "미충족" and step6_selections.get("s2_6_req_7") == "미충족")',
  'heading_text': '3.2.S 원료의약품',
  'output_1_tag': 'AR',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
                   ' \n'
  ...
  'title_key': 's2_6',
  'title_text': '3.2.S.2 제조\n6. 원료의약품의 제조에 사용되는 원료(출발물질, 중간체, 용매, 시약 등)의 규격변경'},
 {'condition': '(step6_selections.get("s2_6_sub_6e") == "변경 있음") and (step6_selections.get("s2_6_req_1") == "미충족" and '
               'step6_selections.get("s2_6_req_2") == "미충족" and step6_selections.get("s2_6_req_3") == "미충족" and '
               'step6_selections.get("s2_6_req_4") == "미충족" and step6_selections.get("s2_6_req_5") == "미충족" and '
               'step6_selections.get("s2_6_req_6") == "미충족" and step6_selections.get("s2_6_req_7") == "미충족" and '
               'step6_selections.get("s2_6_req_8") == "미충족" and step6_selections.get("s2_6_req_9") == "미충족")',
  ...
  'title_key': 's2_6',
  'title_text': '3.2.S.2 제조\n6. 원료의약품의 제조에 사용되는 원료(출발물질, 중간체, 용매, 시약 등)의 규격변경'},
 {'condition': '(step6_selections.get("s2_6_sub_6f") == "변경 있음") and (step6_selections.get("s2_6_req_3") == "충족" and '
               'step6_selections.get("s2_6_req_6") == "충족" and step6_selections.get("s2_6_req_7") == "충족" and '
               'step6_selections.get("s2_6_req_9") == "충족") and (step6_selections.get("s2_6_req_1") == "미충족" and '
               'step6_selections.get("s2_6_req_2") == "미충족" and step6_selections.get("s2_6_req_4") == "미충족" and '
               'step6_selections.get("s2_6_req_5") == "미충족" and step6_selections.get("s2_6_req_8") == "미충족")',
  'heading_text': '3.2.S 원료의약품',
  'output_1_tag': 'AR',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
                   ' \n'
  ...
  'title_key': 's2_6',
  'title_text': '3.2.S.2 제조\n6. 원료의약품의 제조에 사용되는 원료(출발물질, 중간체, 용매, 시약 등)의 규격변경'},
 {'condition': '(step6_selections.get("s2_6_sub_6g") == "변경 있음") and (step6_selections.get("s2_6_req_1") == "미충족" and '
               'step6_selections.get("s2_6_req_2") == "미충족" and step6_selections.get("s2_6_req_3") == "미충족" and '
               'step6_selections.get("s2_6_req_4") == "미충족" and step6_selections.get("s2_6_req_5") == "미충족" and '
               'step6_selections.get("s2_6_req_6") == "미충족" and step6_selections.get("s2_6_req_7") == "미충족" and '
               'step6_selections.get("s2_6_req_8") == "미충족" and step6_selections.get("s2_6_req_9") == "미충족")',
  ...
  'title_key': 's2_6',
  'title_text': '3.2.S.2 제조\n6. 원료의약품의 제조에 사용되는 원료(출발물질, 중간체, 용매, 시약 등)의 규격변경'},
 {'condition': '(step6_selections.get("p1_7_sub_7a") == "변경 있음") and (step6_selections.get("p1_7_req_1") == "충족" and '
               'step6_selections.get("p1_7_req_4") == "충족") and (step6_selections.get("p1_7_req_2") == "미충족" and '
               'step6_selections.get("p1_7_req_3") == "미충족" and step6_selections.get("p1_7_req_5") == "미충족")',
 ...
 {'condition': '(step6_selections.get("p1_7_sub_7b") == "변경 있음") and (step6_selections.get("p1_7_req_1") == "충족" and '
               'step6_selections.get("p1_7_req_2") == "충족" and step6_selections.get("p1_7_req_3") == "충족" and '
               'step6_selections.get("p1_7_req_4") == "충족" and step6_selections.get("p1_7_req_5") == "충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': '보고유형은 다음과 같습니다.\n'
                  '\n'
                  'IR, 시판전보고\n'
 ...
 {'condition': '(step6_selections.get("p1_7_sub_7b") == "변경 있음") and (step6_selections.get("p1_7_req_1") == "충족" and '
               'step6_selections.get("p1_7_req_2") == "충족" and step6_selections.get("p1_7_req_3") == "충족" and '
               'step6_selections.get("p1_7_req_4") == "충족") and (step6_selections.get("p1_7_req_5") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': 'Cmin',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
                   '\n'
  ...
  'title_key': 'p1_7',
  'title_text': '3.2.P.1 완제의약품의 성상 및 조성\n7. 완제의약품 중 고형 제제의 조성 변경'},
 {'condition': '(step6_selections.get("p1_7_sub_7c") == "변경 있음") and (step6_selections.get("p1_7_req_1") == "충족" and '
               'step6_selections.get("p1_7_req_4") == "충족") and (step6_selections.get("p1_7_req_2") == "미충족" and '
               'step6_selections.get("p1_7_req_3") == "미충족" and step6_selections.get("p1_7_req_5") == "미충족" and '
               'step6_selections.get("p1_7_req_6") == "미충족" and step6_selections.get("p1_7_req_7") == "미충족" and '
               'step6_selections.get("p1_7_req_8") == "미충족" and step6_selections.get("p1_7_req_9") == "미충족" and '
  ...
  'output_2_text': '필요서류는 다음과 같습니다.\n'
                   '\n'
                   '1. (P.2 또는 R) 「의약품동등성시험기준」 [별표2] 원료약품 및 그 분량 변경수준 및 제출자료 범위에 따른 의약품동등성시험자료 및 실시한 의약품동등성시험이 동 규정에 '
                   '적합함을 입증하는 자료.\n'
                   '2. (P.1) 완제의약품의 성상 및 원료약품 분량.\n'
                   '3. (P.2) 변경하고자 하는 제제의 성분에 대한 검토 자료(예: 첨가제의 선택, 원료의약품과 첨가제의 배합 적합성).\n'
                   '4. (P.3) 배치 조성에 대한 자료.\n'
                   ...
                   '7. (P.5) 완제의약품의 기준 및 시험방법, 최소 1배치(파일럿 배치 이상)에 대한 시험 성적서.\n'
                   '8. (P.5.3) 해당되는 경우, 변경된 첨가제가 완제의약품의 분석 절차를 방해하지 않는다는 것을 입증하는 자료.\n'
                   '9. (P.8.1) 변경 후 완제의약품 최소 2배치(파일럿 배치 이상)에 대한 장기 및 가속 안정성 시험 최소 3개월 자료. 생물학적동등성시험을 제출하는 경우, 장기 및 가속 '
                   '최소 6개월 자료.\n'
                   '10. (P.8.2) 변경하고자 하는 제제의 생산 규모 배치에 대한 안정성 시험 계획서 및 이행서약.',
  'requirements_met': 'step6_selections.get("p1_7_req_1") == "충족"\nstep6_selections.get("p1_7_req_4") == "충족"',
  'requirements_unmet': 'step6_selections.get("p1_7_req_2") == "미충족"\n'
 ...
 {'condition': 'True',
  ...
  'requirements_met': '보고유형은 다음과 같습니다.\n'
                      '\n'
                      'Cmaj, 변경허가(신고)\n'
                      '「의약품의 품목허가‧신고‧심사 규정」 제3조의2(의약품의 허가‧신고의 변경 처리) 및 제6조(국제공통기술문서 작성)에 따라 원료의약품과 완제의약품의 제조원 또는 제조방법 '
                      '중 품질에 중요한 영향을 미치는 변경허가(신고) 신청(Change, C) 대상에 해당하며, 변경사항의 중요도, 충족조건 및 제출자료 요건의 난이도 등을 고려하였을 때 '
                      'Major change(Cmaj)수준의 변경사항입니다.',
  'requirements_unmet': '필요서류는 다음과 같습니다.\n'
                        '\n'
                        '1. (P.1) 완제의약품의 원료약품 분량.\n'
                        '2. (P.2 또는 R) 「의약품동등성시험기준」 [별표2] 원료약품 및 그 분량 변경수준 및 제출자료 범위에 따른 의약품동등성시험자료 및 실시한 의약품동등성시험이 동 '
                        '규정에 적합함을 입증하는 자료.\n'
                        '3. (P.3) 배치 조성에 대한 자료.\n'
  ...
  'title_key': 'p1_8',
  'title_text': '3.2.P.1 완제의약품의 성상 및 조성\n8. 고형제제의 코팅층 무게 변경'},
 {'condition': '(step6_selections.get("p1_9_req_1") == "충족") or '
               '(step6_selections.get("p1_9_req_2") == "충족") or '
               '(step6_selections.get("p1_9_req_3") == "충족") or '
               '(step6_selections.get("p1_9_req_4") == "충족") or '
               '(step6_selections.get("p1_9_req_5") == "충족") or '
               '(step6_selections.get("p1_9_req_6") == "충족") or '
  ...
  'output_1_text': '필요서류는 다음과 같습니다.\n'
                   '\n'
                   '1. (P.2 또는 R) 「의약품동등성시험기준」 [별표2] 원료약품 및 그 분량 변경수준 및 제출자료 범위에 따른 의약품동등성시험자료 및 실시한 의약품동등성시험이 동 규정에 '
                   '적합함을 입증하는 자료로서, 완제의약품의 물리화학적 특성에 변화가 없음을 입증할 수 있는 이화학적동등성시험자료(예. 점도, 삼투압, pH 등).\n'
                   '3. (P.1) 완제의약품의 성상 및 조성.\n'
                   '4. (P.2) 변경하고자 하는 제제의 구성 성분에 대한 검토 자료(예: 첨가제의 선택, 원료약품과 첨가제 간의 배합성, 변경된 제제의 포장 시스템 적합성 시험), 주사제, '
                   '점안제 및 점이제의 경우 유효성분에 영향을 미치지 않음을 입증하는 자료로서 변경가능 첨가제 내 종류가 상이하거나 종류는 동일하고 분량만 상이한 경우 가속 6개월 안정성 시험자료 '
                   '제출\n'
                   ...
                   '10. (P.8.1) 변경 후 완제의약품 최소 2배치(파일럿 배치 이상)에 대한 장기 및 가속 안정성 시험 최소 3개월 자료. 생물학적동등성시험을 제출하는 경우, 장기 및 가속 '
                   '최소 6개월 자료\n'
  ...
  'step': '7',
  'subitem_and_requirements_state': '(subitem_met == "") and (requirements_met != "") and (requirements_unmet != "")',
  'subitem_met': "any of p1_9_req_1 ~ p1_9_req_7 == '충족'",
  'title_key': 'p1_9',
  'title_text': '3.2.P.1 완제의약품의 성상 및 조성\n9. 완제의약품(고형제제 제외)의 조성 변경'},
 {'condition': '(step6_selections.get("p1_9_req_8") == "충족" and step6_selections.get("p1_9_req_9") == "충족") and '
               '(step6_selections.get("p1_9_req_1") == "미충족" and step6_selections.get("p1_9_req_2") == "미충족" and '
               'step6_selections.get("p1_9_req_3") == "미충족" and step6_selections.get("p1_9_req_4") == "미충족" and '
               'step6_selections.get("p1_9_req_5") == "미충족" and step6_selections.get("p1_9_req_6") == "미충족" and '
  ...
  'output_1_text': '필요서류는 다음과 같습니다.\n'
                   '\n'
                   '2. (P.2 또는 R) 「의약품동등성시험기준」 [별표2] 원료약품 및 그 분량 변경수준 및 제출자료 범위에 따른 의약품동등성시험자료 및 실시한 의약품동등성시험이 동 규정에 '
                   '적합함을 입증하는 자료로서, 생물학적동등성시험자료 또는 비교임상시험자료, 또는 생물학적동등성시험자료를 갈음할 수 있는 타당한 자료.\n'
                   '3. (P.1) 완제의약품의 성상 및 조성.\n'
                   '4. (P.2) 변경하고자 하는 제제의 구성 성분에 대한 검토 자료(예: 첨가제의 선택, 원료약품과 첨가제 간의 배합성, 변경된 제제의 포장 시스템 적합성 시험), 주사제, '
                   '점안제 및 점이제의 경우 유효성분에 영향을 미치지 않음을 입증하는 자료로서 변경가능 첨가제 내 종류가 상이하거나 종류는 동일하고 분량만 상이한 경우 가속 6개월 안정성 시험자료 '
                   '제출\n'
  ...
  'title_key': 'p1_9',
  'title_text': '3.2.P.1 완제의약품의 성상 및 조성\n9. 완제의약품(고형제제 제외)의 조성 변경'},
 {'condition': '(step6_selections.get("p1_10_sub_10a") == "변경 있음") and (step6_selections.get("p1_10_req_1") == "충족" '
               'and step6_selections.get("p1_10_req_3") == "충족" and step6_selections.get("p1_10_req_4") == "충족" and '
               'step6_selections.get("p1_10_req_8") == "충족" and step6_selections.get("p1_10_req_9") == "충족") and '
               '(step6_selections.get("p1_10_req_2") == "미충족" and step6_selections.get("p1_10_req_5") == "미충족" and '
               'step6_selections.get("p1_10_req_6") == "미충족" and step6_selections.get("p1_10_req_7") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': 'AR',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
                   ' \n'
  ...
  'title_key': 'p1_10',
  'title_text': '3.2.P.1 완제의약품의 성상 및 조성\n10. 완제의약품(고형제제 제외)에 쓰이는 착색제 또는 착향제의 종류와 분량의 변경'},
 {'condition': '(step6_selections.get("p1_10_sub_10b") == "변경 있음") and (step6_selections.get("p1_10_req_1") == "충족" '
               'and step6_selections.get("p1_10_req_2") == "충족" and step6_selections.get("p1_10_req_3") == "충족" and '
               'step6_selections.get("p1_10_req_4") == "충족" and step6_selections.get("p1_10_req_8") == "충족" and '
               'step6_selections.get("p1_10_req_9") == "충족") and (step6_selections.get("p1_10_req_5") == "미충족" and '
               'step6_selections.get("p1_10_req_6") == "미충족" and step6_selections.get("p1_10_req_7") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': 'Cmin',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
  ...
  'title_key': 'p1_10',
  'title_text': '3.2.P.1 완제의약품의 성상 및 조성\n10. 완제의약품(고형제제 제외)에 쓰이는 착색제 또는 착향제의 종류와 분량의 변경'},
 {'condition': '(step6_selections.get("p1_10_sub_10c") == "변경 있음") and (step6_selections.get("p1_10_req_1") == "충족" '
               'and step6_selections.get("p1_10_req_2") == "충족" and step6_selections.get("p1_10_req_3") == "충족" and '
               'step6_selections.get("p1_10_req_5") == "충족" and step6_selections.get("p1_10_req_6") == "충족" and '
               'step6_selections.get("p1_10_req_7") == "충족" and step6_selections.get("p1_10_req_8") == "충족" and '
               'step6_selections.get("p1_10_req_9") == "충족") and (step6_selections.get("p1_10_req_4") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': 'Cmin',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
                   '\n'
  ...
  'output_2_text': '필요서류는 다음과 같습니다.\n'
                   ...
                   '1. (P.1) 완제의약품의 원료약품 분량.\n'
                   '2. (P.3) 배치 조성에 대한 자료.\n'
                   '3. (P.2) 완제의약품의 성분에 대한 검토 자료(예: 착색제나 착향제가 관련 규격이 첨부된 혼합물로 구입된 경우, 원료의약품과 착색제나 착향제의 성분 조성과의 배합 '
                   '적합성).\n'
                   '4. (P.4) 착색제 또는 착향제의 규격 및 성적서. 사람 또는 동물 유래 물질이 사용되는 경우, 출처가 새로운 원료약품에 대한 BSE/TSE(소해면상뇌증/전염성해면상뇌증) '
                   '위해 적합성 평가 자료.\n'
                   '5. (P.5) 완제의약품 기준 및 시험방법 및 최소 1배치(파일럿 배치 이상) 이상의 시험 성적서.\n'
  ...
  'title_key': 'p1_10',
  'title_text': '3.2.P.1 완제의약품의 성상 및 조성\n10. 완제의약품(고형제제 제외)에 쓰이는 착색제 또는 착향제의 종류와 분량의 변경'},
 {'condition': '(step6_selections.get("p3_11_sub_11a") == "변경 있음") and (step6_selections.get("p3_11_req_1") == "충족" '
               'and step6_selections.get("p3_11_req_2") == "충족" and step6_selections.get("p3_11_req_3") == "충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': '보고유형은 다음과 같습니다.\n'
                  '\n'
                  'Cmin, 변경허가(신고)\n'
 ...
 {'condition': '(step6_selections.get("p3_11_sub_11b") == "변경 있음") and (step6_selections.get("p3_11_req_1") == "충족" '
               'and step6_selections.get("p3_11_req_2") == "충족" and step6_selections.get("p3_11_req_3") == "충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': '보고유형은 다음과 같습니다.\n'
                  '\n'
  ...
  'output_1_text': '필요서류는 다음과 같습니다.\n'
                   '\n'
                   '1. (P.2 또는 R) 「의약품동등성시험기준」 [별표3] 제조방법의 변경수준 및 제출자료의 범위에 따른 의약품동등성시험자료 및 실시한 의약품동등성시험이 동 규정에 적합함을 '
                   '입증하는 자료.\n'
                   '2. 완제의약품의 성상.\n'
                   '3. (P.3) 배치 조성에 대한 자료, 제조공정 및 공정관리의 설명자료, 해당되는 경우, 제조공정 파라미터 변경을 확인할 수 있는 자료.\n'
                   '4. (P.5) 변경된 기준 및 시험방법.\n'
  ...
  'title_key': 'p3_11',
  'title_text': '3.2.P.3 제조\n11. 정성적 또는 정량적인 조성과 평균 질량의 변경이 없는 성상의 변경'},
 {'condition': '(step6_selections.get("p3_12_sub_12a") == "변경 있음") and (step6_selections.get("p3_12_req_2") == "충족") '
               'and (step6_selections.get("p3_12_req_1") == "미충족" and step6_selections.get("p3_12_req_3") == "미충족" and '
               'step6_selections.get("p3_12_req_4") == "미충족" and step6_selections.get("p3_12_req_5") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': 'Cmin',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
                   '\n'
  ...
  'output_2_text': '필요서류는 다음과 같습니다.\n'
                   '\n'
                   '1. (해당하는 경우) 해당 제조소의 ‘의약품 등의 안전에 관한 규칙’ 제48조의2에 따른 제조 및 품질관리기준 적합판정서 또는 해외 제조원인 경우 제4조제1항제4호에 따른 '
                   '유효기간 내의 제조증명서.\n'
  ...
  'title_key': 'p3_12',
  'title_text': '3.2.P.3 제조\n12. 완제의약품 제조공정의 일부 또는 전부에 대한 제조소 추가 또는 변경'},
 {'condition': '(step6_selections.get("p3_12_sub_12b") == "변경 있음") and (step6_selections.get("p3_12_req_2") == "충족" '
               'and step6_selections.get("p3_12_req_3") == "충족" and step6_selections.get("p3_12_req_4") == "충족") and '
               '(step6_selections.get("p3_12_req_1") == "미충족" and step6_selections.get("p3_12_req_5") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': 'Cmin',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
                   '\n'
  ...
  'output_2_text': '필요서류는 다음과 같습니다.\n'
                   ...
                   '유효기간 내의 제조증명서.\n'
                   '2. (P.3.1) 수탁업소를 포함한 각 제조원, 주소, 책임소재 등의 자료.\n'
                   '8. (P.8.2) 변경 후 생산규모 배치에 대한 안정성 시험 계획 및 이행서약. 단, 생물학적동등성시험을 제출하는 경우, 최소 2배치(파일럿 배치 이상)의 장기 및 가속 최소 '
                   '6개월 자료. 다만, 일반제제(장용성 및 방출조절제제, 서방성제제 등 제형의 특수성이 인정되는 제제 외)에 해당하는 경우 ‘최소 2배치(1개의 파일럿 배치 이상 포함)’',
  'requirements_met': 'step6_selections.get("p3_12_req_2") == "충족"\n'
 ...
 {'condition': '(step6_selections.get("p3_12_sub_12b") == "변경 있음") and (step6_selections.get("p3_12_req_2") == "충족" '
  ...
  'title_key': 'p3_12',
  'title_text': '3.2.P.3 제조\n12. 완제의약품 제조공정의 일부 또는 전부에 대한 제조소 추가 또는 변경'},
 {'condition': '(step6_selections.get("p3_12_sub_12c") == "변경 있음") and (step6_selections.get("p3_12_req_1") == "충족" '
               'and step6_selections.get("p3_12_req_2") == "충족") and (step6_selections.get("p3_12_req_3") == "미충족" and '
               'step6_selections.get("p3_12_req_4") == "미충족" and step6_selections.get("p3_12_req_5") == "미충족" and '
               'step6_selections.get("p3_12_req_6") == "미충족" and step6_selections.get("p3_12_req_7") == "미충족" and '
  ...
  'output_2_text': '필요서류는 다음과 같습니다.\n'
                   ...
                   '4. (P.2 또는 R) 「의약품동등성시험기준」 [별표4] 제조소의 변경수준 및 제출자료 범위에 따른 의약품동등성시험자료 및 실시한 의약품동등성시험이 동 규정에 적합함을 '
                   '입증하는 자료.\n'
                   '5. (P.3.5) 변경 후 (위험도 평가에 따른) 실생산 규모의 3배치에 대한 공정 밸리데이션 보고서 또는 밸리데이션 실시 계획서.\n'
  ...
  'title_text': '3.2.P.3 제조\n12. 완제의약품 제조공정의 일부 또는 전부에 대한 제조소 추가 또는 변경'},
 {'condition': '(step6_selections.get("p3_12_sub_12c") == "변경 있음") and (step6_selections.get("p3_12_req_1") == "충족" '
               'and step6_selections.get("p3_12_req_2") == "충족" and step6_selections.get("p3_12_req_5") == "충족") and '
               '(step6_selections.get("p3_12_req_3") == "미충족" and step6_selections.get("p3_12_req_4") == "미충족" and '
               'step6_selections.get("p3_12_req_6") == "미충족" and step6_selections.get("p3_12_req_7") == "미충족" and '
               'step6_selections.get("p3_12_req_9") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': 'Cmin',
  ...
  'title_key': 'p3_12',
  'title_text': '3.2.P.3 제조\n12. 완제의약품 제조공정의 일부 또는 전부에 대한 제조소 추가 또는 변경'},
 {'condition': '(step6_selections.get("p3_12_sub_12c") == "변경 있음") and (step6_selections.get("p3_12_req_2") == "충족") '
               'and (step6_selections.get("p3_12_req_1") == "미충족" and step6_selections.get("p3_12_req_3") == "미충족" and '
               'step6_selections.get("p3_12_req_4") == "미충족" and step6_selections.get("p3_12_req_5") == "미충족" and '
               'step6_selections.get("p3_12_req_6") == "미충족" and step6_selections.get("p3_12_req_7") == "미충족" and '
               'step6_selections.get("p3_12_req_9") == "미충족")',
  ...
  'title_key': 'p3_12',
  'title_text': '3.2.P.3 제조\n12. 완제의약품 제조공정의 일부 또는 전부에 대한 제조소 추가 또는 변경'},
 {'condition': '(step6_selections.get("p3_13_sub_13a") == "변경 있음") and (step6_selections.get("p3_13_req_1") == "충족" '
               'and step6_selections.get("p3_13_req_2") == "충족" and step6_selections.get("p3_13_req_3") == "충족" and '
               'step6_selections.get("p3_13_req_4") == "충족") and (step6_selections.get("p3_13_req_5") == "미충족" and '
  ...
  'title_key': 'p3_13',
  'title_text': '3.2.P.3 제조\n13. 비무균제제의 제조 규모 변경'},
 {'condition': '(step6_selections.get("p3_13_sub_13b") == "변경 있음") and (step6_selections.get("p3_13_req_1") == "충족" '
               'and step6_selections.get("p3_13_req_2") == "충족" and step6_selections.get("p3_13_req_3") == "충족" and '
               'step6_selections.get("p3_13_req_4") == "충족" and step6_selections.get("p3_13_req_5") == "충족") and '
               '(step6_selections.get("p3_13_req_6") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': 'IR',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
 ...
 {'condition': '(step6_selections.get("p3_13_sub_13b") == "변경 있음") and (step6_selections.get("p3_13_req_1") == "충족" '
               'and step6_selections.get("p3_13_req_2") == "충족" and step6_selections.get("p3_13_req_3") == "충족" and '
               'step6_selections.get("p3_13_req_4") == "충족" and step6_selections.get("p3_13_req_6") == "충족") and '
  ...
  'title_key': 'p3_13',
  'title_text': '3.2.P.3 제조\n13. 비무균제제의 제조 규모 변경'},
 {'condition': '(step6_selections.get("p3_13_sub_13c") == "변경 있음") and (step6_selections.get("p3_13_req_1") == "충족" '
               'and step6_selections.get("p3_13_req_2") == "충족" and step6_selections.get("p3_13_req_3") == "충족" and '
               'step6_selections.get("p3_13_req_4") == "충족") and (step6_selections.get("p3_13_req_5") == "미충족" and '
               'step6_selections.get("p3_13_req_6") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  ...
  'title_key': 'p3_13',
  'title_text': '3.2.P.3 제조\n13. 비무균제제의 제조 규모 변경'},
 {'condition': '(step6_selections.get("p3_14_req_1") == "충족" and step6_selections.get("p3_14_req_2") == "충족" and '
               'step6_selections.get("p3_14_req_3") == "충족" and step6_selections.get("p3_14_req_4") == "충족") and '
               '(step6_selections.get("p3_14_req_5") == "미충족" and step6_selections.get("p3_14_req_6") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': '보고유형은 다음과 같습니다.\n'
                  ' \n'
                  'AR, 연차보고\n'
 ...
 {'condition': '(step6_selections.get("p3_14_req_1") == "충족" and step6_selections.get("p3_14_req_2") == "충족" and '
               'step6_selections.get("p3_14_req_3") == "충족" and step6_selections.get("p3_14_req_4") == "충족" and '
               'step6_selections.get("p3_14_req_5") == "충족") and (step6_selections.get("p3_14_req_6") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': '보고유형은 다음과 같습니다.\n'
                  '\n'
                  'IR, 시판전보고\n'
 ...
 {'condition': '(step6_selections.get("p3_14_req_1") == "충족" and step6_selections.get("p3_14_req_2") == "충족" and '
               'step6_selections.get("p3_14_req_3") == "충족" and step6_selections.get("p3_14_req_4") == "충족" and '
               'step6_selections.get("p3_14_req_6") == "충족") and (step6_selections.get("p3_14_req_5") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': '보고유형은 다음과 같습니다.\n'
                  '\n'
                  'Cmaj, 변경허가(신고)\n'
  ...
  'output_1_text': '필요서류는 다음과 같습니다.\n'
                   ...
                   '4. (P.5.4) 변경 전·후 생산 규모 완제의약품의 최소 1배치에 대한 배치 분석 자료(비교표 형식).\n'
                   '5. (P.8.2) 변경 후 제제의 생산규모 배치에 대한 안정성 시험 계획 및 이행서약.\n'
                   '6. (P.2 또는 R) 「의약품동등성시험기준」 [별표3] 제조방법의 변경수준 및 제출자료 범위에 따른 의약품동등성시험자료 및 실시한 의약품동등성시험이 동 규정에 적합함을 '
                   '입증하는 자료.',
  'output_2_text': '',
  'requirements_met': 'step6_selections.get("p3_14_req_5") == "미충족"',
  'requirements_unmet': 'Cmaj',
  ...
  'title_key': 'p3_14',
  'title_text': '3.2.P.3 제조\n14. 무균제제의 제조 규모 변경'},
 {'condition': '(step6_selections.get("p3_15_sub_15a") == "변경 있음") and (step6_selections.get("p3_15_req_1") == "충족" '
               'and step6_selections.get("p3_15_req_2") == "충족" and step6_selections.get("p3_15_req_3") == "충족" and '
               'step6_selections.get("p3_15_req_4") == "충족" and step6_selections.get("p3_15_req_5") == "충족" and '
               'step6_selections.get("p3_15_req_6") == "충족" and step6_selections.get("p3_15_req_7") == "충족") and '
               '(step6_selections.get("p3_15_req_8") == "미충족" and step6_selections.get("p3_15_req_9") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': 'AR',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
                   ' \n'
  ...
  'output_2_text': '필요서류는 다음과 같습니다.\n'
                   ...
                   '• In-Vitro 비교시험 자료, 예를 들면, 고형 제제 단위에 대한 기준 및 시험방법에서의 다시점 용출 프로파일(생산 배치 1배치, 이전 공정의 1배치와 대조약 배치 결과에 '
                   '대한 비교 자료. 규격을 벗어나는 경우 보고하여야 한다).\n'
                   '• 원료의약품을 용해 상태 또는 비용해 상태로 함유하는 비무균 반고형 제형에 대한 In-Vitro 멤브레인 확산시험(membrane release test) 자료(생산 배치 '
                   '1배치 및 이전 공정의 1배치와 대조약 배치 결과에 대한 비교 자료\n'
  ...
  'title_key': 'p3_15',
  'title_text': '3.2.P.3 제조\n15. 완제의약품의 제조공정 변경'},
 {'condition': '(step6_selections.get("p3_15_sub_15b") == "변경 있음") and (step6_selections.get("p3_15_req_1") == "충족" '
               'and step6_selections.get("p3_15_req_2") == "충족" and step6_selections.get("p3_15_req_3") == "충족" and '
               'step6_selections.get("p3_15_req_4") == "충족" and step6_selections.get("p3_15_req_5") == "충족" and '
               'step6_selections.get("p3_15_req_6") == "충족" and step6_selections.get("p3_15_req_7") == "충족" and '
               'step6_selections.get("p3_15_req_8") == "충족") and (step6_selections.get("p3_15_req_9") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': 'IR',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
                   '\n'
  ...
  'output_2_text': '필요서류는 다음과 같습니다.\n'
                   ...
                   '3. (P.3) 배치 조성, 제조공정과 공정관리의 설명 자료, 주요 단계와 중간체의 관리, (해당되는 경우) 공정 밸리데이션 실시 계획서 및/또는 평가에 관한 자료.\n'
                   '4. (P.5) 변경 전·후 생산 규모 1배치에 대한 규격 및 시험성적서.\n'
                   '5. (P.8.1) 최소 2배치(파일럿배치이상)에 대한 3개월 가속 및 장기안정성 시험결과, 의약품동등성시험으로 생물학적동등성시험을 제출하는 경우 2배치(파일럿배치이상)에 대한 '
                   '장기 및 가속 안정성 시험 최소 6개월 자료. 다만, 충족조건 3(일반제제에 해당한다.)를 만족하는 경우 ‘최소 2배치(1개의 파일럿 배치 이상 포함)’.\n'
                   '6. (P.8.2) 변경 후 제제의 생산규모 배치에 대한 안정성 시험 계획 및 이행서약.\n'
                   '7. (R.1) 해당 변경 사항 외에 제조 관련 문서에 일체의 변경이 없다는 내용의 확인서(statement).',
  'requirements_met': 'step6_selections.get("p3_15_req_1") == "충족"\n'
                      'step6_selections.get("p3_15_req_2") == "충족"\n'
 ...
 {'condition': '(step6_selections.get("p3_15_sub_15b") == "변경 있음") and (step6_selections.get("p3_15_req_1") == "충족" '
               ...
               'step6_selections.get("p3_15_req_4") == "충족" and step6_selections.get("p3_15_req_5") == "충족" and '
               'step6_selections.get("p3_15_req_6") == "충족" and step6_selections.get("p3_15_req_7") == "충족" and '
               'step6_selections.get("p3_15_req_8") == "충족" and step6_selections.get("p3_15_req_9") == "충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': '보고유형은 다음과 같습니다.\n'
                  '\n'
                  'IR, 시판전보고\n'
  ...
  'title_key': 'p3_15',
  'title_text': '3.2.P.3 제조\n15. 완제의약품의 제조공정 변경'},
 {'condition': '(step6_selections.get("p3_15_sub_15c") == "변경 있음") and (step6_selections.get("p3_15_req_1") == "미충족" '
               'and step6_selections.get("p3_15_req_2") == "미충족" and step6_selections.get("p3_15_req_3") == "미충족" and '
               'step6_selections.get("p3_15_req_4") == "미충족" and step6_selections.get("p3_15_req_5") == "미충족" and '
               'step6_selections.get("p3_15_req_6") == "미충족" and step6_selections.get("p3_15_req_7") == "미충족" and '
               'step6_selections.get("p3_15_req_8") == "미충족" and step6_selections.get("p3_15_req_9") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': '보고유형은 다음과 같습니다.\n'
                  '\n'
  ...
  'title_key': 'p3_15',
  'title_text': '3.2.P.3 제조\n15. 완제의약품의 제조공정 변경'},
 {'condition': '(step6_selections.get("p3_16_sub_16a") == "변경 있음") and (step6_selections.get("p3_16_req_1") == "충족" '
               'and step6_selections.get("p3_16_req_2") == "충족" and step6_selections.get("p3_16_req_4") == "충족") and '
  ...
  'title_key': 'p3_16',
  'title_text': '3.2.P.3 제조\n16. 완제의약품 또는 반제품의 제조에 적용되는 공정관리시험 또는 공정관리시험 기준(IPC)의 변경'},
 {'condition': '(step6_selections.get("p3_16_sub_16b") == "변경 있음") and (step6_selections.get("p3_16_req_2") == "충족") '
               'and (step6_selections.get("p3_16_req_1") == "미충족" and step6_selections.get("p3_16_req_3") == "미충족" and '
  ...
  'title_key': 'p3_16',
  'title_text': '3.2.P.3 제조\n16. 완제의약품 또는 반제품의 제조에 적용되는 공정관리시험 또는 공정관리시험 기준(IPC)의 변경'},
 {'condition': '(step6_selections.get("p3_16_sub_16c") == "변경 있음") and (step6_selections.get("p3_16_req_2") == "충족" '
               'and step6_selections.get("p3_16_req_3") == "충족") and (step6_selections.get("p3_16_req_1") == "미충족" and '
               'step6_selections.get("p3_16_req_4") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': 'AR',
  'output_1_text': '보고유형은 다음과 같습니다.\n'
  ...
  'title_key': 'p3_16',
  'title_text': '3.2.P.3 제조\n16. 완제의약품 또는 반제품의 제조에 적용되는 공정관리시험 또는 공정관리시험 기준(IPC)의 변경'},
 {'condition': '(step6_selections.get("p3_16_sub_16d") == "변경 있음") and (step6_selections.get("p3_16_req_2") == "충족") '
               'and (step6_selections.get("p3_16_req_1") == "미충족" and step6_selections.get("p3_16_req_3") == "미충족" and '
               'step6_selections.get("p3_16_req_4") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': 'AR',
  ...
  'title_key': 'p3_16',
  'title_text': '3.2.P.3 제조\n16. 완제의약품 또는 반제품의 제조에 적용되는 공정관리시험 또는 공정관리시험 기준(IPC)의 변경'},
 {'condition': '(step6_selections.get("p3_16_sub_16e") == "변경 있음") and (step6_selections.get("p3_16_req_2") == "충족") '
               'and (step6_selections.get("p3_16_req_1") == "미충족" and step6_selections.get("p3_16_req_3") == "미충족" and '
               'step6_selections.get("p3_16_req_4") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': 'AR',
  ...
  'title_key': 'p3_16',
  'title_text': '3.2.P.3 제조\n16. 완제의약품 또는 반제품의 제조에 적용되는 공정관리시험 또는 공정관리시험 기준(IPC)의 변경'},
 {'condition': '(step6_selections.get("p4_17_sub_17a") == "변경 있음") and (step6_selections.get("p4_17_req_1") == "충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': '보고유형은 다음과 같습니다.\n'
                  ' \n'
                  'AR, 연차보고\n'
 ...
 {'condition': '(step6_selections.get("p4_17_sub_17b") == "변경 있음") and (step6_selections.get("p4_17_req_1") == "미충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': '보고유형은 다음과 같습니다.\n'
                  '\n'
                  'Cmin, 변경허가(신고)\n'
  ...
  'title_key': 'p4_17',
  'title_text': '3.2.P.4 첨가제의 관리\n17. 첨가제 기원의 변경'},
 {'condition': '(step6_selections.get("p4_18_req_1") == "충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': '필요서류는 다음과 같습니다.\n'
                  '\n'
  ...
  'requirements_unmet': '보고유형은 다음과 같습니다.\n'
                        ...
                        '「의약품의 품목허가‧신고‧심사 규정」 제3조의2(의약품의 허가‧신고의 변경 처리) 및 제6조(국제공통기술문서 작성)에 따라 원료의약품과 완제의약품의 제조원 또는 '
                        '제조방법 중 품질에 중요한 영향을 미치는 변경허가(신고) 신청(Change, C) 대상에 해당하며, 변경사항의 중요도, 충족조건 및 제출자료 요건의 난이도 등을 '
                        '고려하였을 때 Minor change(Cmin)수준의 변경사항입니다.',
  'step': '7',
  'subitem_and_requirements_state': '(subitem_met == "") and (requirements_met != "") and (requirements_unmet == "")',
  'subitem_met': 'step6_selections.get("p4_18_req_1") == "충족"',
  'title_key': 'p4_18',
  'title_text': '3.2.P.4 첨가제의 관리\n18. 별규에 해당하는 첨가제의 규격 또는 시험방법 변경'},
 {'condition': '(step6_selections.get("p4_19_req_1") == "충족")',
  'heading_text': '3.2.P 완제의약품',
  ...
  'title_key': 'p4_19',
  'title_text': '3.2.P.4 첨가제의 관리\n19. 식약처장이 인정하는 공정서 규격으로 첨가제 규격의 변경'},
 {'condition': '(step6_selections.get("p7_20_req_1") == "충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': '필요서류는 다음과 같습니다.\n'
                  '\n'
                  '1. 용기·포장 재질 변경이 반영된 의약품의 성상.\n'
                  '2. (P.2) (해당하는 경우) 현재의 포장 시스템에 비해 동등하거나 우수한 보호성을 입증하는 용기 마개 시스템의 적합성에 대한 자료. 기능성 포장을 변경하는 경우, 새로운 '
                  '포장의 기능성을 입증하는 자료, 기허가 의약품에서 변경하고자 하는 용기·포장 재질의 사용례 등.',
  'output_1_text': '',
  'output_2_text': '',
  'requirements_met': 'IR',
  'requirements_unmet': '보고유형은 다음과 같습니다.\n'
 ...
 {'condition': '(step6_selections.get("p7_20_req_1") == "충족")',
  ...
  'title_key': 'p7_20',
  'title_text': '3.2.P.7 용기-마개 시스템\n20. 비무균제제의 직접용기 및 포장 재질, 종류 변경'},
 {'condition': '(step6_selections.get("p7_21_req_1") == "충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': '필요서류는 다음과 같습니다.\n'
                  '\n'
                  '1. 용기·포장 재질 변경이 반영된 의약품의 성상.\n'
                  '2. (P.2) 현재의 포장 시스템에 비해 동등하거나 우수한 보호성을 입증하는 용기 마개 시스템의 적합성에 대한 자료. 기능성 포장을 변경하는 경우, 새로운 포장의 기능성을 '
                  '입증하는 자료.',
  'output_1_text': '',
  'output_2_text': '',
  'requirements_met': 'Cmin',
 ...
 {'condition': '(step6_selections.get("p7_21_req_1") == "충족")',
  ...
  'title_key': 'p7_21',
  'title_text': '3.2.P.7 용기-마개 시스템\n21. 무균제제의 직접용기 및 포장 재질, 종류 변경'},
 {'condition': '(step6_selections.get("p7_22_req_1") == "충족" and step6_selections.get("p7_22_req_2") == "충족")',
  'heading_text': '3.2.P 완제의약품',
  'output_1_tag': '필요서류는 다음과 같습니다.\n'
                  '\n'
 ...
 {'condition': '(step6_selections.get("p7_22_req_1") == "충족" and step6_selections.get("p7_22_req_2") == "충족")',
  ...
  'title_key': 'p7_22',
  'title_text': '3.2.P.7 용기-마개 시스템\n22. 직접 포장의 규격 변경'},
 {'condition': '(step6_selections.get("p7_23_req_1") == "충족" and step6_selections.get("p7_23_req_2") == "충족")',
  'heading_text': '3.2.P 완제의약품',
  ...
  'title_key': 'p7_23',
  'title_text': '3.2.P.7 용기-마개 시스템\n23. 포장단위 변경'},
 {'condition': 'step6_selections.get("ds_24_sub_24a") == "변경 있음"',
  'heading_text': 'ds_24',
  'output_1_tag': '',
  'output_1_text': '',
  'output_2_text': '',
  ...
  'requirements_unmet': '필요서류는 다음과 같습니다.\n'
                        '\n'
                        '1. 변경에 따른 디자인 스페이스가 타당함을 입증하는 자료(위해평가 및 다변량 연구를 포함하여 디자인 스페이스를 구성하는 다양한 파라미터들의 상호작용에 대한 연구결과를 '
                        '통해 도출되었음을 입증하는 자료.\n'
                        '2. 표 형식으로 디자인 스페이스를 설명한 자료.\n'
                        '3. 신청 서류의 변경과 관련된 CTD 자료.',
  'step': '7',
  'subitem_and_requirements_state': 'output_if_all_conditions_met = (\n'
 ...
 {'condition': 'step6_selections.get("ds_24_sub_24b") == "변경 있음"',
  'heading_text': 'ds_24',
  'output_1_tag': '',
  'output_1_text': '',
  'output_2_text': '',
