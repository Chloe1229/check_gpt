...
STEP7_ROWS = [
  ...
  {
    "제목_키" : "s2_3" ,
    "output_condition_all_met" : "output_if_all_conditions_met = (\n step6_selections.get(\"s2_3_req_1\") == \"미충족\" and step6_selections.get(\"s2_3_req_2\") == \"미충족\" and step6_selections.get(\"s2_3_req_3\") == \"미충족\" and step6_selections.get(\"s2_3_req_4\") == \"미충족\" and step6_selections.get(\"s2_3_req_5\") == \"미충족\" and step6_selections.get(\"s2_3_req_6\") == \"미충족\" and step6_selections.get(\"s2_3_req_7\") == \"미충족\" 그리고 step6_selections.get(\"s2_3_req_8\") == \"미충족\"이고 step6_selections.get(\"s2_3_req_9\") == \"미충족\"\n)"입니다 .
    "output_1_tag" : "Cmaj" ,
    "output_1_text": "보고유형은 다음과 같습니다.\n\nCmaj, 변경허가(신고)\n「의약품의 품목허가‧신고‧심사 규정」 제3조의2(의약품의 허가‧신고의 변경 처리) 및 제6조(국제공통기술문서 작성)에 따라 원료의약품과 완제의약품의 제조원 또는 제조방법 중 품질에 중요한 영향을 미치는 변경허가(신고) 신청(Change, C) 대상에 해당하며, 변경사항의 중요도, 충족조건 및 제출자료 요건의 난이도 등을 고려하였을 때 Major change(Cmaj)수준의 변경사항입니다.",
  ...
  {
    "제목_키" : "p1_9" ,
    "output_condition_all_met" : "output_if_all_conditions_met = (\n step6_selections.get(\"p1_9_req_1\") == \"충족\" and step6_selections.get(\"p1_9_req_2\") == \"충족\" and step6_selections.get(\"p1_9_req_3\") == \"충족\" and step6_selections.get(\"p1_9_req_4\") == \"충족\" and step6_selections.get(\"p1_9_req_5\") == \"충족\" and step6_selections.get(\"p1_9_req_6\") == \"충족\" and step6_selections.get(\"p1_9_req_7\") == \"충족\" and step6_selections.get(\"p1_9_req_9\") == \"충족\" 및 step6_selections.get(\"p1_9_req_8\") == \"미충족\"\n)" ,
    "output_1_tag" : "Cmaj" ,
    "output_1_text": "보고유형은 다음과 같습니다.\n\nCmaj, 변경허가(신고)\n「의약품의 품목허가‧신고‧심사 규정」 제3조의2(의약품의 허가‧신고의 변경 처리) 및 제6조(국제공통기술문서 작성)에 따라 원료의약품과 완제의약품의 제조원 또는 제조방법 중 품질에 중요한 영향을 미치는 변경허가(신고) 신청(Change, C) 대상에 해당하며, 변경사항의 중요도, 충족조건 및 제출자료 요건의 난이도 등을 고려하였을 때 Major change(Cmaj)수준의 변경사항입니다.",
  ...
  {
    "제목_키" : "p1_10" ,
    "output_condition_all_met" : "output_if_all_conditions_met = (\n step6_selections.get(\"p1_10_sub_10a\") == \"변경 있음\" and step6_selections.get(\"p1_10_req_1\") == \"충족\" and step6_selections.get(\"p1_10_req_3\") == \"충족\" and step6_selections.get(\"p1_10_req_4\") == \"충족\" and step6_selections.get(\"p1_10_req_8\") == \"충족\" and step6_selections.get(\"p1_10_req_9\") == \"충족\" and step6_selections.get(\"p1_10_req_2\") == \"미충족\" 및 step6_selections.get(\"p1_10_req_5\") == \"미충족\" 및 step6_selections.get(\"p1_10_req_6\") == \"미충족\" 및 step6_selections.get(\"p1_10_req_7\") == \"미충족\"\n)" ,
    "output_1_tag" : "AR" ,
    "output_1_text": "보고유형은 다음과 같습니다.\n \nAR, 연차보고\n「의약품의 품목허가‧신고‧심사 규정」 제3조의2 제2항 및 제4항에 따른 연차보고(Annual Report, AR) 수준의 변경사항입니다.",
  ...
  {
    "제목_키" : "p1_10" ,
    "output_condition_all_met" : "output_if_all_conditions_met = (\n step6_selections.get(\"p1_10_sub_10b\") == \"변경 있음\" and step6_selections.get(\"p1_10_req_1\") == \"충족\" and step6_selections.get(\"p1_10_req_2\") == \"충족\" and step6_selections.get(\"p1_10_req_3\") == \"충족\" and step6_selections.get(\"p1_10_req_4\") == \"충족\" and step6_selections.get(\"p1_10_req_8\") == \"충족\" and step6_selections.get(\"p1_10_req_9\") == \"충족\" 및 step6_selections.get(\"p1_10_req_5\") == \"미충족\" 및 step6_selections.get(\"p1_10_req_6\") == \"미충족\" 및 step6_selections.get(\"p1_10_req_7\") == \"미충족\"\n)" ,
    "output_1_tag" : "Cmin" ,
    "output_1_text": "보고유형은 다음과 같습니다.\n\nCmin, 변경허가(신고)\n「의약품의 품목허가‧신고‧심사 규정」 제3조의2(의약품의 허가‧신고의 변경 처리) 및 제6조(국제공통기술문서 작성)에 따라 원료의약품과 완제의약품의 제조원 또는 제조방법 중 품질에 중요한 영향을 미치는 변경허가(신고) 신청(Change, C) 대상에 해당하며, 변경사항의 중요도, 충족조건 및 제출자료 요건의 난이도 등을 고려하였을 때 Minor change(Cmin)수준의 변경사항입니다.",
    "output_2_text": "필요서류는 다음과 같습니다.\n\n1. (P.1) 완제의약품의 원료약품 분량.\n2. (P.3) 배치 조성에 대한 자료.\n5. (P.5) 완제의약품 기준 및 시험방법 및 최소 1배치(파일럿 배치 이상) 이상의 시험 성적서.\n7. (P.8.2) 변경 후 제제의 생산규모 배치에 대한 안정성 시험 계획 및 이행서약.\n8. (R.1) 해당 변경 사항 외에 제조 관련 문서에 일체의 변경이 없다는 내용의 확인서(statement)."
  },
  {
    "제목_키" : "p1_10" ,
    "output_condition_all_met" : "output_if_all_conditions_met = (\n step6_selections.get(\"p1_10_sub_10c\") == \"변경 있음\" and step6_selections.get(\"p1_10_req_1\") == \"충족\" and step6_selections.get(\"p1_10_req_2\") == \"충족\" and step6_selections.get(\"p1_10_req_3\") == \"충족\" and step6_selections.get(\"p1_10_req_5\") == \"충족\" and step6_selections.get(\"p1_10_req_6\") == \"충족\" and step6_selections.get(\"p1_10_req_7\") == \"충족\" 및 step6_selections.get(\"p1_10_req_8\") == \"충족\" 및 step6_selections.get(\"p1_10_req_9\") == \"충족\" 및 step6_selections.get(\"p1_10_req_4\") == \"미충족\"\n)" ,
    "output_1_tag" : "Cmin" ,
    "output_1_text": "보고유형은 다음과 같습니다.\n\nCmin, 변경허가(신고)\n「의약품의 품목허가‧신고‧심사 규정」 제3조의2(의약품의 허가‧신고의 변경 처리) 및 제6조(국제공통기술문서 작성)에 따라 원료의약품과 완제의약품의 제조원 또는 제조방법 중 품질에 중요한 영향을 미치는 변경허가(신고) 신청(Change, C) 대상에 해당하며, 변경사항의 중요도, 충족조건 및 제출자료 요건의 난이도 등을 고려하였을 때 Minor change(Cmin)수준의 변경사항입니다.",
  ...
  {
    "제목_키" : "p3_15" ,
    "output_condition_all_met" : "output_if_all_conditions_met = (\n step6_selections.get(\"p3_15_sub_15a\") == \"변경 있음\" and step6_selections.get(\"p3_15_req_1\") == \"충족\" and step6_selections.get(\"p3_15_req_2\") == \"충족\" and step6_selections.get(\"p3_15_req_3\") == \"충족\" and step6_selections.get(\"p3_15_req_4\") == \"충족\" and step6_selections.get(\"p3_15_req_5\") == \"충족\" and step6_selections.get(\"p3_15_req_6\") == \"충족\" 및 step6_selections.get(\"p3_15_req_7\") == \"충족\" 및 step6_selections.get(\"p3_15_req_8\") == \"미충족\" 및 step6_selections.get(\"p3_15_req_9\") == \"미충족\"\n)" ,
    "output_1_tag" : "AR" ,
    "output_1_text": "보고유형은 다음과 같습니다.\n \nAR, 연차보고\n「의약품의 품목허가‧신고‧심사 규정」 제3조의2 제2항 및 제4항에 따른 연차보고(Annual Report, AR) 수준의 변경사항입니다.",
  ...
  {
    "제목_키" : "p3_15" ,
    "output_condition_all_met" : "output_if_all_conditions_met = (\n step6_selections.get(\"p3_15_sub_15b\") == \"변경 있음\" and step6_selections.get(\"p3_15_req_1\") == \"충족\" and step6_selections.get(\"p3_15_req_2\") == \"충족\" and step6_selections.get(\"p3_15_req_3\") == \"충족\" and step6_selections.get(\"p3_15_req_4\") == \"충족\" and step6_selections.get(\"p3_15_req_5\") == \"충족\" and step6_selections.get(\"p3_15_req_6\") == \"충족\" 및 step6_selections.get(\"p3_15_req_7\") == \"충족\" 및 step6_selections.get(\"p3_15_req_8\") == \"충족\" 및 step6_selections.get(\"p3_15_req_9\") == \"미충족\"\n)" ,
    "output_1_tag" : "IR" ,
    "output_1_text": "보고유형은 다음과 같습니다.\n\nIR, 시판전보고\n「의약품의 품목허가‧신고‧심사 규정」 제3조의2제4항 단서조항에 따른 시판전 보고(Immediate Report, IR) 수준의 변경사항입니다.",
  ...
  {
    "제목_키" : "p3_15" ,
    "output_condition_all_met" : "output_if_all_conditions_met = (\n step6_selections.get(\"p3_15_sub_15b\") == \"변경 있음\" and step6_selections.get(\"p3_15_req_1\") == \"충족\" and step6_selections.get(\"p3_15_req_2\") == \"충족\" and step6_selections.get(\"p3_15_req_3\") == \"충족\" and step6_selections.get(\"p3_15_req_4\") == \"충족\" and step6_selections.get(\"p3_15_req_5\") == \"충족\" and step6_selections.get(\"p3_15_req_6\") == \"충족\" 및 step6_selections.get(\"p3_15_req_7\") == \"충족\" 및 step6_selections.get(\"p3_15_req_8\") == \"충족\" 및 step6_selections.get(\"p3_15_req_9\") == \"충족\"\n)" ,
    "output_1_tag" : "IR" ,
    "output_1_text": "보고유형은 다음과 같습니다.\n\nIR, 시판전보고\n「의약품의 품목허가‧신고‧심사 규정」 제3조의2제4항 단서조항에 따른 시판전 보고(Immediate Report, IR) 수준의 변경사항입니다.",
    "output_2_text": "필요서류는 다음과 같습니다.\n\n2. (P.2) 해당되는 경우, 제조 공정의 개발에 관한 검토 자료:\n• In-Vitro 비교시험 자료, 예를 들면, 고형 제제 단위에 대한 기준 및 시험방법에서의 다시점 용출 프로파일(생산 배치 1배치, 이전 공정의 1배치와 대조약 배치 결과에 대한 비교 자료. 규격을 벗어나는 경우 보고하여야 한다).\n• 원료의약품을 용해 상태 또는 비용해 상태로 함유하는 비무균 반고형 제형에 대한 In-Vitro 멤브레인 확산시험(membrane release test) 자료(생산 배치 1배치 및 이전 공정의 1배치와 대조약 배치 결과에 대한 비교 자료\n• 원료의약품이 비용해 상태로 존재하는 액상 제제에 대해서는 형상의 가시적 변화를 점검하기 위한 현미경 상 자료와 입자 크기 분포의 비교 자료\n3. (P.3) 배치 조성, 제조공정과 공정관리의 설명 자료, 주요 단계와 중간체의 관리, (해당되는 경우) 공정 밸리데이션 실시 계획서 및/또는 평가에 관한 자료.\n4. (P.5) 변경 전·후 생산 규모 1배치에 대한 규격 및 시험성적서.\n5. (P.8.1) 최소 2배치(파일럿배치이상)에 대한 3개월 가속 및 장기안정성 시험결과, 의약품동등성시험으로 생물학적동등성시험을 제출하는 경우 2배치(파일럿배치이상)에 대한 장기 및 가속 안정성 시험 최소 6개월 자료. 다만, 충족조건 3(일반제제에 해당한다.)를 만족하는 경우 ‘최소 2배치(1개의 파일럿 배치 이상 포함)’.\n6. (P.8.2) 변경 후 제제의 생산규모 배치에 대한 안정성 시험 계획 및 이행서약.\n7. (R.1) 해당 변경 사항 외에 제조 관련 문서에 일체의 변경이 없다는 내용의 확인서(statement)."
  },
  {
    "제목_키" : "p3_15" ,
    "output_condition_all_met" : "output_if_all_conditions_met = (\n step6_selections.get(\"p3_15_sub_15c\") == \"변경 있음\" and step6_selections.get(\"p3_15_req_1\") == \"미충족\" and step6_selections.get(\"p3_15_req_2\") == \"미충족\" and step6_selections.get(\"p3_15_req_3\") == \"미충족\" and step6_selections.get(\"p3_15_req_4\") == \"미충족\" and step6_selections.get(\"p3_15_req_5\") == \"미충족\" and step6_selections.get(\"p3_15_req_6\") == \"미충족\" 및 step6_selections.get(\"p3_15_req_7\") == \"미충족\" 및 step6_selections.get(\"p3_15_req_8\") == \"미충족\" 및 step6_selections.get(\"p3_15_req_9\") == \"미충족\"\n)" ,
    "output_1_tag" : "Cmaj" ,
    "output_1_text": "보고유형은 다음과 같습니다.\n\nCmaj, 변경허가(신고)\n「의약품의 품목허가‧신고‧심사 규정」 제3조의2(의약품의 허가‧신고의 변경 처리) 및 제6조(국제공통기술문서 작성)에 따라 원료의약품과 완제의약품의 제조원 또는 제조방법 중 품질에 중요한 영향을 미치는 변경허가(신고) 신청(Change, C) 대상에 해당하며, 변경사항의 중요도, 충족조건 및 제출자료 요건의 난이도 등을 고려하였을 때 Major change(Cmaj)수준의 변경사항입니다.",
    "output_2_text": "필요서류는 다음과 같습니다.\n\n1. (P.2 또는 R) 「의약품동등성시험기준」 [별표3] 제조방법의 변경수준 및 제출자료의 범위에 따른 의약품동등성시험자료 및 실시한 의약품동등성시험이 동 규정에 적합함을 입증하는 자료.\n2. (P.2) 해당되는 경우, 제조 공정의 개발에 관한 검토 자료:\n• In-Vitro 비교시험 자료, 예를 들면, 고형 제제 단위에 대한 기준 및 시험방법에서의 다시점 용출 프로파일(생산 배치 1배치, 이전 공정의 1배치와 대조약 배치 결과에 대한 비교 자료. 규격을 벗어나는 경우 보고하여야 한다).\n• 원료의약품을 용해 상태 또는 비용해 상태로 함유하는 비무균 반고형 제형에 대한 In-Vitro 멤브레인 확산시험(membrane release test) 자료(생산 배치 1배치 및 이전 공정의 1배치와 대조약 배치 결과에 대한 비교 자료\n• 원료의약품이 비용해 상태로 존재하는 액상 제제에 대해서는 형상의 가시적 변화를 점검하기 위한 현미경 상 자료와 입자 크기 분포의 비교 자료\n3. (P.3) 배치 조성, 제조공정과 공정관리의 설명 자료, 주요 단계와 중간체의 관리, (해당되는 경우) 공정 밸리데이션 실시 계획서 및/또는 평가에 관한 자료.\n4. (P.5) 변경 전·후 생산 규모 1배치에 대한 규격 및 시험성적서.\n5. (P.8.1) 최소 2배치(파일럿배치이상)에 대한 3개월 가속 및 장기안정성 시험결과, 의약품동등성시험으로 생물학적동등성시험을 제출하는 경우 2배치(파일럿배치이상)에 대한 장기 및 가속 안정성 시험 최소 6개월 자료. 다만, 충족조건 3(일반제제에 해당한다.)를 만족하는 경우 ‘최소 2배치(1개의 파일럿 배치 이상 포함)’.\n6. (P.8.2) 변경 후 제제의 생산규모 배치에 대한 안정성 시험 계획 및 이행서약.\n7. (R.1) 해당 변경 사항 외에 제조 관련 문서에 일체의 변경이 없다는 내용의 확인서(statement)."
  },
